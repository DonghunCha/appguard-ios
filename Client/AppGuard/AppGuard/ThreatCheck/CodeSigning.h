...
//  AppGuard
//
//  Created by NHNEnt on 2019. 2. 12..
//  Copyright © 2019년 nhnent. All rights reserved.
//
// 참조 코드 : https://opensource.apple.com/source/Security/Security-55179.1/libsecurity_codesigning/lib/cscdefs.h
...
// 참조 코드: https://opensource.apple.com/source/libsecurity_codesigning/libsecurity_codesigning-36591/lib/codedirectory.h.auto.html
enum {
    cdHashTypeSHA1 = 1,
    cdHashTypeSHA256 = 2,
    
    cdHashTypeDefault = cdHashTypeSHA1 // 원본 코드 그대로 가져왔기 때문에 해당값이 설정되어있음. 앱가드에서는 의미가 없음
};
